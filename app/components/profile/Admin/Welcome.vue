    ...
    <template #body>
      <div class="flex flex-col gap-4">
        <p class="text-gray-600">
          Ihre Website ist unter der folgenden vorläufigen Adresse erreichbar:
        </p>
        ...
        <p class="text-gray-600">
          Eine eigene Domain (z.B. meinefirma.de) können Sie in den <UIcon
            name="i-heroicons-cog-6-tooth"
            class="size-5 inline-block align-text-bottom"
          /> Einstellungen verbinden.
        </p>
        <p class="text-gray-600">
          Aktuell ist Ihre Website <strong>nur für Sie sichtbar</strong>. Vervollständigen Sie in den <UIcon
            name="i-heroicons-cog-6-tooth"
            class="size-5 inline-block align-text-bottom"
          /> Einstellungen Ihre <UIcon
            name="i-heroicons-building-office-2"
            class="size-5 inline-block align-text-bottom"
          /> Unternehmensdaten, um sie veröffentlichen zu können.
        </p>
