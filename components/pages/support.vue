  ...
  <PagesLandingpageColorMode class="font-poppins text-[16px]/[1.6] bg-slate-50 text-slate-900 dark:bg-[#0b1020] dark:text-[#e7ecf4]">
    ...
    <div class="mx-auto flex flex-col justify-center py-16 lg:py-24 max-w-7xl px-6 lg:px-8">
      ...
      <p class="mt-8 text-lg/8 text-gray-600">
        ...
        Mehr dazu finden Sie in meiner <a href="/datenschutz"
          class="text-sky-500 hover:underline">Datenschutzerklärung</a>.
      </p>
      <p class="mt-8 text-lg/8 text-gray-600">
      ...
      <UButton
        ...
        target="_blank"
        rel="noopener noreferrer" download class="no-underline mb-2"
      >
      ...
      <UButton href="https://github.com/rustdesk/rustdesk/releases/download/1.4.0/rustdesk-1.4.0-x86_64.dmg" target="_blank"
        rel="noopener noreferrer" download class="no-underline">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path fill="currentColor"
      ...
      <UButton
        ...
        color="primary"
      >
        <svg v-if="copied" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
      ...
      <video controls class="w-full mt-8 rounded-md shadow-xl">
        <source src="/rustdesk.mp4" type="video/mp4">
