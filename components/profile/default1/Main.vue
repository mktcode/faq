  ...
  >
    ...
    <div class="flex flex-col items-center justify-center gap-2 max-w-lg mx-auto py-12 px-6">
      <div
        ...
        class="my-6 w-full"
      >
        <ProfileDefault1Gallery :images="currentSettings?.gallery" />
      </div>
      ...
      <div
        ...
        class="my-24 w-full"
      >
        <ProfileDefault1Offer :offers="currentSettings.offers" />
      </div>
      ...
      <div
        ...
        class="my-6 w-full"
      >
        <ProfileDefault1Downloads :downloads="currentSettings?.downloads || []" />
      </div>
